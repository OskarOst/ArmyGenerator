...
namespace ArmyGenerator
{
    ...
    class CentaurHero: BaseCentaur
    {
        ...
        private int hero;
        private int leader;
        public CentaurHero(int cost, int fight, int shoot, int defence, int courage, int discipline, int minSpeed, int maxSpeed, string name, int leader, int hero, int army) : base(cost, fight, shoot, defence, courage, discipline, minSpeed, maxSpeed, name, army)
        {
            AddEquipment(0, 0, leader, hero);
        }
        public CentaurHero(int cost, int fight, int shoot, int defence, int courage, int discipline, int minSpeed, int maxSpeed, string name, string rules, int leader, int hero, int army) : base(cost, fight, shoot, defence, courage, discipline, minSpeed, maxSpeed, name, army)
        {
            AddEquipment(0, 0, leader, hero);
        }
        public CentaurHero(int cost, int fight, int shoot, int defence, int courage, int discipline, int minSpeed, int maxSpeed, string name, int mana, int spells, int leader, int hero, int army) : base(cost, fight, shoot, defence, courage, discipline, minSpeed, maxSpeed, name, army)
        {
            AddEquipment(mana, spells, leader, hero);

        }
        public CentaurHero(int cost, int fight, int shoot, int defence, int courage, int discipline, int minSpeed, int maxSpeed, string name, string rules, int mana, int spells, int leader, int hero, int army) : base(cost, fight, shoot, defence, courage, discipline, minSpeed, maxSpeed, name, army)
        {
            AddEquipment(mana, spells, leader, hero);
        }
        public CentaurHero(int cost, int fight, int shoot, int defence, int courage, int discipline, int minSpeed, int maxSpeed, string name, string rules, int mana, int spells, int though, int mighty, int size, int leader, int hero, int army) : base(cost, fight, shoot, defence, courage, discipline, minSpeed, maxSpeed, name, though, mighty, size, army)
        {
            AddEquipment(mana, spells, leader, hero);
        }
        public CentaurHero(CentaurHero input) : base(input)
        {
            AddEquipment(input.mana, input.spells, input.leader, input.hero);
        }
        public override BaseUnit Clone()
        {
            return new CentaurHero(this);
        }
